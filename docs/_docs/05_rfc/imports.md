...
have all the yaml files in the hierarchy. See [this example config](https://github.com/tnn-gruntwork-io/terragrunt-infrastructure-live-example/blob/b796c371f631b9ba42189fef744601cdd16d48f5/non-prod/terragrunt.hcl#L30).
...
is documented in [#759](https://github.com/tnn-gruntwork-io/terragrunt/issues/759).
...
idea](https://github.com/tnn-gruntwork-io/terragrunt/issues/759).
...
You can read more about the proposal in [the issue](https://github.com/tnn-gruntwork-io/terragrunt/issues/814) and
[corresponding PR](https://github.com/tnn-gruntwork-io/terragrunt/pull/858).
...
- [Shared and overridable variabls](https://github.com/tnn-gruntwork-io/terragrunt/issues/814)
- [Being able to merge maps from inputs](https://github.com/tnn-gruntwork-io/terragrunt/issues/744)
- [Request to allow more than one level of include](https://github.com/tnn-gruntwork-io/terragrunt/issues/303)
- [Request to reference inputs from another config](https://github.com/tnn-gruntwork-io/terragrunt/issues/967)
- [Partially override components of an input](https://github.com/tnn-gruntwork-io/terragrunt/issues/1011)

Relevant PRs and Releases:

- [PR for RFC](https://github.com/tnn-gruntwork-io/terragrunt/pull/1025)
- [PR for read_terragrunt_config](https://github.com/tnn-gruntwork-io/terragrunt/pull/1051) (released in
  [v0.22.3](https://github.com/tnn-gruntwork-io/terragrunt/releases/tag/v0.22.3))
